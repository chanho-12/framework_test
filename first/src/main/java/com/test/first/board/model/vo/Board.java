...
public class Board implements java.io.Serializable {
	...
	private int board_ref; //원글 : 자기번호, 댓글 : 원글번호
	private int board_reply_ref; //댓글 : 자기번호, 대댓글 : 댓글번호
	private int board_lev; //원글 : 1, 댓글 : 2, 대댓글: 3
	private int board_reply_seq; //댓글 | 대댓글 순번(최근글 1이 됨)
	...
	public void setBoard_reply_lev(int board_reply_lev) {
		this.board_lev = board_reply_lev;
	}
