...
public class Member implements java.io.Serializable {
	...
	//스프링에서 데이터베이스 테이블 컬럼명과 필드명을 일치시키면
	//마이바티스 매퍼의 resultMap 이 자동 작동 실행됨
	...
	public Member(String userid, String userpwd, String username, String gender, int age, String phone, String email,
			String hobby, String etc, Date enrolldate, Date lastmodified, String login_ok, String admin) {
		super();
		this.userid = userid;
	...
	public String toString() {
		return "Member [userid=" + userid + ", userpwd=" + userpwd + ", username=" + username + ", gender=" + gender
				...
				+ ", enrolldate=" + enroll_date + ", lastmodified=" + lastmodified + ", login_ok=" + login_ok
				+ ", admin=" + admin + "]";
	} 
